const { SlashCommandBuilder, ActionRowBuilder, ModalBuilder, TextInputBuilder, TextInputStyle, PermissionFlagsBits, PermissionBitField } = require('discord.js');
...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    await interaction.showModal(SayModal);
     ...
     interaction.reply({content: `You don't have permission to use this command! Required permission: Manage Messages`, ephemeral: true});
  }
}
}